...
public class ImageUtilTests {
  ...
  public void testReadPPM() {
    PixelRGB[][] image = ImageUtil.readPPM("imagesForTest/1black1white.ppm");
  ...
  public void testWritePPM() throws IOException {
    PixelRGB[][] image = ImageUtil.readPPM("imagesForTest/TestImageWith4Pixels.ppm");
    ImageUtil.writePPM(image, "imagesForTest/testWrite.ppm");
    PixelRGB[][] checkerImage = ImageUtil.readPPM("imagesForTest/testWrite.ppm");
    ...
    File file = new File("imagesForTest/testWrite.ppm");
    file.delete();
